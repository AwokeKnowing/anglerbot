...
if __name__ == "__main__":
    ...
    try:
        while True:
            ...
            dt0=datetime.now()
            tempsource,rgbd,intrinsic = topdowncam.frame(3,4)
            ...
            if with_forward:
                ...
                if with_forward_alignment and frame_count % 30 ==15:
                    topdown_pcd.estimate_normals(o3d.geometry.KDTreeSearchParamHybrid(radius=voxel_size *
                                                     2,
                                                     max_nn=30))
                    if True:
        ...
        # draw 
            if frame_count ==0:
                ...
                if show_topdown_roi_box:
                    c=-.48
                    above_ground_bbox_topdown = bbox_from_xxyyzz(tdx1-c,tdx2+c,tdy1-c,tdy2+c,floor_z,tdz2,(1, 0, 0))
